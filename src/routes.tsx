...
import { MedicalRecord } from './pages/Dashboard/components/Home/PatientsList/components/PatientDetails/components/PatientMedicalHubModal/components/MedicalRecord/MedicalRecord'
